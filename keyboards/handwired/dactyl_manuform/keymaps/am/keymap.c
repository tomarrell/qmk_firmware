...
[_BASE] = KEYMAP( \
  ...
  KC_LSFT,   KC_HOME, KC_Z,    KC_X,   KC_C,    KC_V, KC_B,            KC_N,     KC_M,     KC_COMMA, KC_DOT,  KC_SLASH,  KC_ENTER, KC_RSFT, KC_PSCR, \
...
[_NAV] = KEYMAP( \
  ...
  KC_INS,  KC_END, _______, _______, _______, _______, _______,       _______, _______, _______, _______, _______,    _______,  _______,  _______, \
